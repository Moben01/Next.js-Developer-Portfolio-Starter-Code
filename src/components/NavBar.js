        ...
        <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8 '>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                <nav>
                    ...
                    <CustomLink href="/articles" title="DS Projects" className='mx-4' />
                    <CustomLink href="/articles" title="Products" className='mx-4' />
                ...
                isOpen ?
                    ...
                    className='min-w-[70vw]  flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 '>
                        <nav className='flex items-center flex-col justify-center'>
                            ...
                            <CustomMobileLink href="/articles" title="DS Projects" className='' toggle={handleClick} />
                            <CustomMobileLink href="/articles" title="Products" className='' toggle={handleClick} />
